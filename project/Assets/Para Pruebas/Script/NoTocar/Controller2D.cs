...
public class Controller2D : MonoBehaviour {
	...
	BoxCollider2D mi_Coll;
	// Referencia a la struct declarada mas abajo
	OrigenesRaycast Origenes_Ray;
	...
	void ColisionesHorizontales(ref Vector3 Velocidad) {
		// Creamos dos variables, una que sea la direccion del rayo que sera el valor del eje X
	...
	void ColisionesVerticales(ref Vector3 Velocidad) {
		// Creamos dos variables, una que sea la direccion del rayo que sera el valor del eje Y
		// que le entre de los axis del jugador y otra la longitud que igualara el valor absoluto de
	...
	void ActualizarRaycastOrigenes() {
